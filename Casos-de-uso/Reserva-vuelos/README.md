...
| Flujo alterno y excepciones | Si no hay asientos disponibles en el vuelo en el momento de la reserva, se le informa al pasajero y se cancela la operación. |
...
| Flujo alterno y excepciones | Si por razones de políticas de cancelación u otros supuestos una reserva no se puede cancelar el pasajero no podrá acceder a esta función para ese vuelo concreto. |
...
| Flujo alterno y excepciones | Si no hay resultados que coincidan con la búsqueda se le hará saber al pasajero y se le mostrarán resultados similares|
...
| Flujo alterno y excepciones | Si el pasajero se arrepiente antes de confirmar la eliminación podrá elegir cancelar el proceso. |
